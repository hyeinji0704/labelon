...
export const WorkBoardHeader: React.FC<WorkBoardHeaderProps> = ({
	...
	return (
		<div className="workboard-header">
			<h2 className="workboard-header__title">{title}</h2>
			<div className="workboard-header__status">
				<span className="workboard-header__time">
					<img
						src="/images/icons/icon-time.svg"
						alt=""
						className="workboard-header__icon"
					/>
					작업시간{" "}
					<span className="workboard-header__value">{time}</span>
				</span>

				<span className="workboard-header__approved">
					<img
						src="/images/icons/icon-confirm.svg"
						alt=""
						className="workboard-header__icon"
					/>
					승인 작업수{" "}
					<span className="workboard-header__value">
						{approvedCount}
					</span>
				</span>
				...
				<span className="workboard-header__total">
					<img
						src="/images/icons/icon-total.svg"
						alt=""
						className="workboard-header__icon"
					/>
					전체 작업수{" "}
